# What is DiscordProximity

DiscordProximity makes it possible to use proximity voice chats on Discord. Currently supported clients are:
- Forge 1.8.9

> [!WARNING]  
> Using client mods are against Discord's TOS, which they have a track record of not enforcing it. Please don't send screenshots or video clips of you using it, I am not responsible for any loss that happens because of this.
...
A: Beaming asks for your email and verification code, the setup only asks for your IGN which everyone else in lobby 1 can also see. However, if you are interesting in beaming, feel free to join me in [the beaming VC](https://discord.gg/tEWSxA3SKV).
